...
--
-- Host: localhost    Database: autofaros
-- ------------------------------------------------------
...
--
-- Table structure for table `arca_cbtes_asoc`
--

DROP TABLE IF EXISTS `arca_cbtes_asoc`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `arca_cbtes_asoc` (
  `id` int NOT NULL AUTO_INCREMENT,
  `arca_comprobante_id` int NOT NULL,
  `asociado_arca_id` int NOT NULL,
  `asoc_pto_vta` int NOT NULL,
  `asoc_cbte_tipo` int NOT NULL,
  `asoc_cbte_nro` bigint NOT NULL,
  `asoc_cbte_fch` char(8) NOT NULL,
  `asoc_cuit` bigint NOT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_arca_asoc` (`arca_comprobante_id`),
  KEY `idx_asociado` (`asociado_arca_id`)
) ENGINE=InnoDB AUTO_INCREMENT=25 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `arca_cierres_diarios`
--

DROP TABLE IF EXISTS `arca_cierres_diarios`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `arca_cierres_diarios` (
  `id` int NOT NULL AUTO_INCREMENT,
  `ambiente` varchar(10) NOT NULL,
  `cuit_emisor` bigint NOT NULL,
  `pto_vta` int NOT NULL,
  `fecha` date NOT NULL,
  `cant_comprobantes` int NOT NULL DEFAULT '0',
  `cant_facturas` int NOT NULL DEFAULT '0',
  `cant_notas_credito` int NOT NULL DEFAULT '0',
  `total_facturado` decimal(12,2) NOT NULL DEFAULT '0.00',
  `total_nc` decimal(12,2) NOT NULL DEFAULT '0.00',
  `total_neto_ventas` decimal(12,2) NOT NULL DEFAULT '0.00',
  ...
  `ids_json` json DEFAULT NULL,
  `snapshot_json` json DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_cierre` (`ambiente`,`cuit_emisor`,`pto_vta`,`fecha`),
  UNIQUE KEY `uniq_env_cuit_pto_fecha` (`ambiente`,`cuit_emisor`,`pto_vta`,`fecha`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `arca_comprobante_items`
--

DROP TABLE IF EXISTS `arca_comprobante_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `arca_comprobante_items` (
  `id` int NOT NULL AUTO_INCREMENT,
  `arca_comprobante_id` int NOT NULL,
  ...
  `bonif` decimal(12,2) NOT NULL DEFAULT '0.00',
  `iva_alicuota` decimal(5,2) NOT NULL,
  `imp_neto` decimal(12,2) NOT NULL,
  `imp_iva` decimal(12,2) NOT NULL,
  `imp_total` decimal(12,2) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `arca_comprobante_id` (`arca_comprobante_id`),
  CONSTRAINT `arca_comprobante_items_ibfk_1` FOREIGN KEY (`arca_comprobante_id`) REFERENCES `arca_comprobantes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=173 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `arca_comprobantes`
--

DROP TABLE IF EXISTS `arca_comprobantes`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `arca_comprobantes` (
  `id` int NOT NULL AUTO_INCREMENT,
  `factura_mostrador_id` int DEFAULT NULL,
  `ambiente` enum('HOMO','PROD') NOT NULL,
  `cuit_emisor` bigint NOT NULL,
  `pto_vta` int NOT NULL,
  `cbte_tipo` int NOT NULL,
  `cbte_nro` bigint DEFAULT NULL,
  `cbte_fch` char(8) NOT NULL,
  `doc_tipo` int NOT NULL,
  `doc_nro` bigint NOT NULL,
  `receptor_nombre` varchar(255) DEFAULT NULL,
  `receptor_cond_iva_id` int DEFAULT NULL,
  `imp_total` decimal(12,2) NOT NULL,
  `imp_neto` decimal(12,2) NOT NULL,
  `imp_iva` decimal(12,2) NOT NULL,
  `imp_exento` decimal(12,2) NOT NULL DEFAULT '0.00',
  `mon_id` varchar(3) NOT NULL DEFAULT 'PES',
  `mon_cotiz` decimal(12,6) NOT NULL DEFAULT '1.000000',
  `resultado` char(1) DEFAULT NULL,
  `cae` varchar(20) DEFAULT NULL,
  `cae_vto` char(8) DEFAULT NULL,
  `obs_code` varchar(20) DEFAULT NULL,
  `obs_msg` varchar(1000) DEFAULT NULL,
  `req_json` longtext,
  `resp_xml` longtext,
  `estado` enum('BORRADOR','PENDIENTE','EMITIDO','RECHAZADO') NOT NULL DEFAULT 'PENDIENTE',
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime DEFAULT NULL,
  `factura_activa` int GENERATED ALWAYS AS ((case when (`estado` in (_utf8mb4'PENDIENTE',_utf8mb4'EMITIDO')) then `factura_mostrador_id` else NULL end)) STORED,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_cbte` (`ambiente`,`cuit_emisor`,`pto_vta`,`cbte_tipo`,`cbte_nro`),
  UNIQUE KEY `uq_factura_activa` (`factura_activa`),
  KEY `ix_factura` (`factura_mostrador_id`),
  KEY `ix_estado` (`estado`),
  KEY `idx_cbte_fch` (`cbte_fch`)
) ENGINE=InnoDB AUTO_INCREMENT=141 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `arca_receptores_cache`
--

DROP TABLE IF EXISTS `arca_receptores_cache`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `arca_receptores_cache` (
  `id` int NOT NULL AUTO_INCREMENT,
  `doc_tipo` int NOT NULL,
  `doc_nro` bigint NOT NULL,
  `nombre` varchar(255) DEFAULT NULL,
  `razon_social` varchar(255) DEFAULT NULL,
  `cond_iva_id` int DEFAULT NULL,
  `domicilio` varchar(255) DEFAULT NULL,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_doc` (`doc_tipo`,`doc_nro`)
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `arca_wsfe_consultas`
--

DROP TABLE IF EXISTS `arca_wsfe_consultas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `arca_wsfe_consultas` (
  `id` int NOT NULL AUTO_INCREMENT,
  `arca_comprobante_id` int NOT NULL,
  ...
  `req_xml` longtext,
  PRIMARY KEY (`id`),
  KEY `ix_arca` (`arca_comprobante_id`),
  CONSTRAINT `fk_arca_wsfe_consultas_arca` FOREIGN KEY (`arca_comprobante_id`) REFERENCES `arca_comprobantes` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=134 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `busquedas_producto`
--

DROP TABLE IF EXISTS `busquedas_producto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `busquedas_producto` (
  `id` int NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_bp_prod` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=928 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `busquedas_producto_log`
--

DROP TABLE IF EXISTS `busquedas_producto_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `busquedas_producto_log` (
  `id` int NOT NULL AUTO_INCREMENT,
  `producto_id` int NOT NULL,
  ...
  KEY `idx_termino` (`termino`),
  CONSTRAINT `fk_busquedas_producto` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=191763 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `busquedas_texto`
--

DROP TABLE IF EXISTS `busquedas_texto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `busquedas_texto` (
  `id` int NOT NULL AUTO_INCREMENT,
  `q` varchar(255) NOT NULL,
  `origen` enum('texto','selectores') NOT NULL DEFAULT 'texto',
  `user_id` int DEFAULT NULL,
  `ip` varchar(45) DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `created_at` (`created_at`),
  KEY `q` (`q`)
) ENGINE=InnoDB AUTO_INCREMENT=16582 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `carritos` (
  ...
  `estado` enum('carrito','pendiente','confirmado','preparación','listo para entrega','finalizado') NOT NULL DEFAULT 'carrito',
  `es_pedido` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
--
-- Table structure for table `descuentos_proveedor`
--

DROP TABLE IF EXISTS `descuentos_proveedor`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `envios` (
  ...
  `direccion` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_envios_carrito` (`carrito_id`),
  CONSTRAINT `envios_ibfk_1` FOREIGN KEY (`carrito_id`) REFERENCES `carritos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=85 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `escobillas_codigo_producto`
--

DROP TABLE IF EXISTS `escobillas_codigo_producto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `escobillas_codigo_producto` (
  `id` int NOT NULL AUTO_INCREMENT,
  `producto_id` int NOT NULL,
  `codigo_norm` varchar(32) NOT NULL,
  `tecnologia` enum('FLEX','STEEL','REAR') NOT NULL DEFAULT 'FLEX',
  `prioridad` int NOT NULL DEFAULT '10',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_producto_codigo_tecnologia` (`producto_id`,`codigo_norm`,`tecnologia`),
  KEY `idx_codigo_norm` (`codigo_norm`),
  KEY `idx_codigo_tecnologia` (`codigo_norm`,`tecnologia`),
  CONSTRAINT `fk_esc_cod_prod` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=57 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `escobillas_kit_producto`
--

DROP TABLE IF EXISTS `escobillas_kit_producto`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `escobillas_kit_producto` (
  `id` int NOT NULL AUTO_INCREMENT,
  `producto_id` int NOT NULL,
  `tecnologia` enum('FLEX','STEEL') NOT NULL DEFAULT 'FLEX',
  `codigo_conductor_norm` varchar(32) NOT NULL,
  `codigo_acompanante_norm` varchar(32) NOT NULL,
  `prioridad` int NOT NULL DEFAULT '10',
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_kit_producto` (`producto_id`,`tecnologia`,`codigo_conductor_norm`,`codigo_acompanante_norm`),
  KEY `idx_kit_busqueda` (`tecnologia`,`codigo_conductor_norm`,`codigo_acompanante_norm`),
  CONSTRAINT `fk_esc_kit_prod` FOREIGN KEY (`producto_id`) REFERENCES `productos` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `facturas_admin_items`
--

DROP TABLE IF EXISTS `facturas_admin_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `facturas_admin_items` (
  `id` int NOT NULL AUTO_INCREMENT,
  `factura_id` int NOT NULL,
  `producto_id` int NOT NULL,
  `cantidad` int NOT NULL,
...
--
-- Table structure for table `facturas_mostrador`
--

DROP TABLE IF EXISTS `facturas_mostrador`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `facturas_mostrador` (
  `id` int NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `facturas_mostrador_arca_estado`
--

DROP TABLE IF EXISTS `facturas_mostrador_arca_estado`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `facturas_mostrador_arca_estado` (
  `factura_id` int NOT NULL,
  `estado` enum('ACTIVA','ANULADA','PARCIAL') NOT NULL DEFAULT 'ACTIVA',
  `arca_factura_id` int DEFAULT NULL,
  `arca_nc_id` int DEFAULT NULL,
  `motivo` varchar(255) DEFAULT NULL,
  `created_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated_at` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`factura_id`),
  KEY `idx_estado` (`estado`),
  KEY `idx_arca_factura` (`arca_factura_id`),
  KEY `idx_arca_nc` (`arca_nc_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `gastos` (
  ...
  `tipo` enum('A','B') NOT NULL DEFAULT 'A',
  `fecha` date NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=10914 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `items_presupuesto`
--
...
CREATE TABLE `notas_credito` (
  ...
  `tipo` enum('descuento','devolucion_mercaderia','diferencia_precio') NOT NULL,
  `iva` enum('21','10.5') NOT NULL,
  `importe_total` decimal(10,2) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_nc_proveedor_numero` (`id_proveedor`,`numero_nota_credito`),
  KEY `idx_nc_proveedor_fecha` (`id_proveedor`,`fecha`),
  KEY `idx_nc_factura` (`id_factura`),
  CONSTRAINT `fk_nc_facturas` FOREIGN KEY (`id_factura`) REFERENCES `facturas` (`id`) ON DELETE SET NULL ON UPDATE CASCADE,
  CONSTRAINT `fk_nc_proveedores` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedores` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE
...
) ENGINE=InnoDB AUTO_INCREMENT=2169 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `presupuesto_productos`
--
...
--
-- Table structure for table `presupuestos_admin_items`
--

DROP TABLE IF EXISTS `presupuestos_admin_items`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `presupuestos_admin_items` (
  `id` int NOT NULL AUTO_INCREMENT,
  `presupuesto_id` int NOT NULL,
  `producto_id` int NOT NULL,
  `cantidad` int NOT NULL,
...
--
-- Table structure for table `presupuestos_mostrador`
--

DROP TABLE IF EXISTS `presupuestos_mostrador`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `presupuestos_mostrador` (
  `id` int NOT NULL AUTO_INCREMENT,
  `nombre_cliente` varchar(255) NOT NULL,
  `fecha` date NOT NULL,
  `total` decimal(10,2) NOT NULL,
  `creado_en` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3391 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `producto_proveedor` (
  ...
  `costo_iva` decimal(12,2) NOT NULL DEFAULT '0.00',
  `iva` decimal(4,1) NOT NULL DEFAULT '21.0',
  `codigo` varchar(255) DEFAULT NULL,
  `actualizado_en` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  `presentacion` enum('unidad','juego') NOT NULL DEFAULT 'unidad',
  `factor_unidad` decimal(10,4) NOT NULL DEFAULT '1.0000',
...
) ENGINE=InnoDB AUTO_INCREMENT=5972 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-03-05 18:26:33
