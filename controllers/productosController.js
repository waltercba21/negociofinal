...
generarStockPDF: async function (req, res) {
    ...
    try {
        ...
        obtenerProductos.then(productos => {
            ...
            .text('Stock', 450, currentY + 10, {align: 'center', width: 40}) 
            .text('Mínimo', 450, currentY + 20, {align: 'center', width: 40}) 
            .text('Stock', 550, currentY + 10, {align: 'center', width: 40}) 
            .text('Actual', 550, currentY + 20, {align: 'center', width: 40}) 
            .fillColor('black');
