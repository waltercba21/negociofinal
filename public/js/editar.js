document.addEventListener('DOMContentLoaded', function() {
    ...
    // Manejador para cambios en el elemento de imagen
    ...
    // Inicializar descuentos de proveedor y manejadores de eventos
    ...
    // Funciones de actualización de precios y proveedores
    $('.precio_lista').on('change', function() {
        actualizarPrecio($(this));
        actualizarProveedorAsignado();
        actualizarPrecioFinal();
    });

    $('#costo_neto').on('change', function() {
    ...
    function actualizarPrecio(precioListaElement) {
        ...
        costoNetoElement.val(Math.ceil(costo));
